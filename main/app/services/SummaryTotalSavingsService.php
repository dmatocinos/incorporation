...
class SummaryTotalSavingsService extends IncorporationEngine {
    ...
    protected function init()
    {
	    ...
	    $total_annual_tax_savings = ($business->isPartnership() ? $this->data["total_tax_as_a_partnership_calculated"] : $this->data["total_tax_as_a_sole_trader_calculated"]) - str_replace( ',', '', $total_tax_as_incorporated);
