...
class GoodwillReporter extends TCPDF {
	...
	public function buildIntroReport()
	{
		// add a page
		$this->AddPage();

		$this->SetFont('rockb', '', 26, '', true);
		$html = View::make("goodwill.pdf_styles")->render();
		$html .= View::make("goodwill.report_intro")->render();
	...
	public function buildReport($params = [])
	{
		...
		$params = array_merge(['data' => $params], ['business' => $this->business]);
		$html = View::make("goodwill.pdf_styles")->render();
		$html .= View::make(
			"goodwill.report", 
			$params
