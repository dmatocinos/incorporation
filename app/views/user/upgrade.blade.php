@section('content')
	...
	<div class="subscribe" style="margin: 30px 0px 0px; text-align: center; width: 100%; float: left;">
		<a style="font-size: 18px; float: center;" class="text-center col-xs-6 btn btn-success logo-color-bg" href="{{ url('upgrade/start_payment/third') }}"> Upgrade to <b>Professional </b> &nbsp; | 41 downloads</a>
	</div>
	...
	<div class="subscribe" style="margin: 30px 0px 0px; text-align: center; width: 100%; float: left;">
		<a style="font-size: 18px; float: center;" class="text-center col-xs-6 btn btn-success logo-color-bg" href="{{ url('upgrade/start_payment/second') }}"> Upgrade to <b>Pro Active </b> &nbsp; | 11 downloads</a>
	</div>
	<div class="subscribe" style="margin: 30px 0px 0px; text-align: center; width: 100%; float: left;">
		<a style="font-size: 18px; float: center;" class="text-center col-xs-6 btn btn-success logo-color-bg" href="{{ url('upgrade/start_payment/third') }}"> Upgrade to <b>Professional </b> &nbsp; | 41 downloads</a>
	</div>
