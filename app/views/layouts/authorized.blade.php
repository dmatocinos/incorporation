		    ...
		    <div class='notifications bottom-left'>
			    <div style="float:left; width: 350px;">
					<div style="width: 200px;">
						<a href="http://app.bizvaluation.co.uk" class="thumbnail" title=" Create a professional business valuation in just 15 minutes" target="_blank"><img src="{{ asset('assets/img/app-logos/bizvaluation_logo.png') }}" style="width: 200px; padding: 10px 0;"/></a>
					</div>
					<div style="width: 200px;">
						<a href="http://priceplannerpro.practicepro.co.uk" class="thumbnail" target="_blank" title="Price professionally and create additional fees"><img src="{{ asset('assets/img/app-logos/priceplannerpro_logo.png') }}" style="width: 95%;"/></a>
					</div>
					<div style="width: 200px;">
						<a href="http://remunerationpro.practicepro.co.uk/" class="thumbnail" title="Maximise your clients' personal income" target="_blank"><img src="{{ asset('assets/img/app-logos/remuneration_logo.png') }}" style="width: 80%;"/></a>
					</div>
					<div style="width: 200px;">
						<a href="http://virtualfdpro.practicepro.co.uk/" class="thumbnail" title="Help your clients achieve their goals" target="_blank"><img src="{{ asset('assets/img/app-logos/virtualfdpro_logo.jpg') }}" style="width: 100%; padding: 5px;"/></a>
					</div>
			    </div>
		    </div>
		</nav>
